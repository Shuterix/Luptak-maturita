...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group relative flex w-full items-center rounded-md border border-border bg-background/80 shadow-xs outline-none transition-[color,box-shadow]",
        ...
        // Focus state (no outline/ring).
        "has-[[data-slot=input-group-control]:focus]:outline-none has-[[data-slot=input-group-control]:focus]:ring-0",
